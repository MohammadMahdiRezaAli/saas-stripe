            ...
            >
              ...
              {item.hasDropdown && (
                <div
                  ...
                  className={`absolute left-0 top-full bg-white shadow-lg ring-1 ring-gray-200 transition-all duration-300 ease-out transform ${
                ...
                >
                  <div className="max-w-7xl mx-auto w-full flex space-x-14 px-6 py-8">
