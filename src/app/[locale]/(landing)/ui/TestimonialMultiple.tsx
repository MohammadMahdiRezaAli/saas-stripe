...
export default function TestimonialMultiple() {
  return (
    <div className="relative isolate w-screen bg-[#1B1340] py-16 lg:py-20">
      ...
      <div className="flex justify-center px-4 lg:px-8">
        <div className="w-full max-w-screen-2xl">
          <div className="mx-auto mt-16 grid max-w-full grid-cols-1 gap-8 text-sm leading-6 text-[#E0E0F1] sm:mt-20 sm:grid-cols-2 xl:grid-flow-col xl:grid-cols-4">
